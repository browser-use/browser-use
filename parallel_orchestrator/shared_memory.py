...
class SharedMemory:
    ...
    async def set(self, key: str, value: Any) -> None:
        """
        Store a value with a specific key (alias for write).
        ...
        Example:
            await shared_memory.set("status", "running")
        """
        await self.write(key, value)

    async def get(self, key: str) -> Any | None:
        """
        Retrieve a value by key (alias for read).
        ...
        Example:
            status = await shared_memory.get("status")
        """
