...
| OrcaRouter | `ChatOrcaRouter` | `ORCAROUTER_API_KEY` |
...
Route across OrcaRouter models through its OpenAI-compatible gateway:
...
**Env:** `ORCAROUTER_API_KEY` | [OrcaRouter](https://www.orcarouter.ai)
