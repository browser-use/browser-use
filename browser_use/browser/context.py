...
class BrowserContext:
	...
	async def _create_context(self, browser: PlaywrightBrowser):
		...
		# Expose basic anti-detection scripts
		...
		# Advanced anti-fingerprinting script for when anti_fingerprint is enabled
		advanced_anti_fingerprint_script = """
            ...
            // Override platform with a common value
