...
class Controller(Generic[Context]):
	def __init__(
		...
		@self.registry.action(
			'Search the query in the default search engine in the current tab, the query should be a search query like humans search, concrete and not vague or super long. More the single most important items.',
