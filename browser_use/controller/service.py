		...
		async def drag_drop(params: DragDropAction, browser: BrowserContext) -> ActionResult:
			...
			try:
				...
				if params.element_source and params.element_target:
					logger.debug(f"Using element-based approach with selectors")
				...
				elif all(coord is not None for coord in [params.coord_source_x, params.coord_source_y, params.coord_target_x, params.coord_target_y]):
					logger.debug(f"Using coordinate-based approach")
