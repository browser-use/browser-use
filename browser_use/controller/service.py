...
class Controller:
    ...
    def _register_default_actions(self):
        ...
        async def extract_content(goal: str, browser: BrowserContext, page_extraction_llm: LLM):
            page = await browser.get_current_page()
            import markdownify
            ...
            try:
                output = page_extraction_llm.model.invoke(template.format(goal=goal, page=content))
    ...
    async def multi_act(
        ...
        page_extraction_llm: Optional[LLM] = None,
