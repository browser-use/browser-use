...
{{
  "thought_summary": "Your private reasoning is removed after this response. Summarize only the useful task-relevant conclusions the next step may need: new information, what failed, unresolved uncertainty, important constraints, and why your next action follows. Be as short as possible without losing useful information. Do not repeat the full reasoning, the user request, the page, or existing memory.",
