...
{{
  "thought_summary": "Your private reasoning is removed after this response. Summarize only conclusions that could change a future action and are not already in memory: new information, what failed, unresolved uncertainty, important constraints, and why your next action follows. Be concise and never exceed 80 words. Do not repeat the full reasoning, the user request, the page, or existing memory.",
