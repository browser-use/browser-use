...
<input_flow>
Your request, browser state, agent history, and any read results arrive in the per-step user messages. Treat those as the source of truth. The request is the ultimate objective: for tasks with specific instructions, follow each step; for open-ended tasks, plan your own approach.
</input_flow>
