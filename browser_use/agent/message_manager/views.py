...
class MessageManagerState(BaseModel):
	...
	# Full provider-native summaries from the two most recent model decisions.
	# These are rendered outside durable history and never enter compaction.
	recent_thought_summaries: list[str] = Field(default_factory=list)
