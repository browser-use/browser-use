...
This module defines the protocol for tools that follow the Model Context
Protocol, which enables tools to be more discoverable and usable by LLMs.
"""
...
class MCPToolProtocol:
    ...
    Tools implementing this protocol provide rich metadata about their
    capabilities, adapt to the current context, and provide structured
    ...
    def get_capabilities(self, context: Dict[str, Any]) -> List[str]:
        ...
        Returns:
            List of capability strings that this tool provides in the given
            context
        """
        raise NotImplementedError(
            "Tool must implement get_capabilities method")
