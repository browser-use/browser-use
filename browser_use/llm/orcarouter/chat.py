...
class ChatOrcaRouter(BaseChatModel):
	"""
	A wrapper around OrcaRouter's chat API, which provides access to various LLM models
	...
	http_referer: str | None = None  # Optional attribution header forwarded to OrcaRouter
	...
	async def ainvoke(
		...
		# Set up extra headers for OrcaRouter
		extra_headers = {}
