...
class ChatOpenAI(BaseChatModel):
	...
	def _get_usage(self, response: ChatCompletion) -> ChatInvokeUsage | None:
		if response.usage is not None:
			# OpenAI already includes reasoning_tokens as a subset of
			# completion_tokens — do NOT add them again or usage will be ~2x
			# inflated for reasoning models (o1, o3, o4-mini, etc.).
