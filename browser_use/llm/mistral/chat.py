...
class ChatMistral(BaseChatModel):
    ...
    async def ainvoke(
        ...
        try:
            ...
            error_message = f'Request validation failed: {"; ".join(error_details)}' if error_details else 'Request validation failed'
    ...
    def _prepare_request_params(self, mistral_messages, output_format: type[T] | None = None) -> dict:
        ...
        if output_format is not None:
            ...
            request_params['response_format'] = ResponseFormat(
                type='json_schema',
