...
def _heuristic_select_method(llm: BaseChatModel) -> str:
...
def _run_iq_check(llm: BaseChatModel) -> bool:
...
def _probe_multiple_msgs(llm: BaseChatModel) -> bool:
...
def test_llm_config(
    llm: BaseChatModel,
    tool_calling_method: str | Literal[
        "auto", "raw", "json_mode", "function_calling", "tools"
    ] = "auto",
) -> LLMStatusDict:
