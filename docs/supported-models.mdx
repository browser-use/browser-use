...
### Avian [example](https://github.com/browser-use/browser-use/blob/main/examples/models/avian.py)

[Avian](https://avian.io) provides cost-effective LLM inference through an OpenAI-compatible API with access to models like DeepSeek-V3.2, Kimi-K2.5, GLM-5, and MiniMax-M2.5.

```python
from browser_use import Agent, ChatAvian
from dotenv import load_dotenv
...
| Model | Input Context | Output Context | Input Price (per 1M) | Output Price (per 1M) |
|-------|--------------|----------------|---------------------|-----------------------|
...
**Examples available:**
- [Avian](https://github.com/browser-use/browser-use/blob/main/examples/models/avian.py)
