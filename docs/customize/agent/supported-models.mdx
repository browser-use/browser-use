...
## CometAPI [example](https://github.com/browser-use/browser-use/blob/main/examples/models/cometapi.py)

[CometAPI](https://www.cometapi.com/?utm_source=browser-use&utm_campaign=integration&utm_medium=integration&utm_content=integration) is an LLM API provider offering 500+ AI models in one unified API. Choose any model that supports function calling.
...
# Get API key from https://api.cometapi.com/console/token
...
## Other models (DeepSeek, Novita, OpenRouter, X...)
