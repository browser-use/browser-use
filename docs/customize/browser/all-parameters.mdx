...
- `page_load_timeout` (default: `10.0`): Maximum time (seconds) to wait for page to finish loading (document.readyState="complete" and no pending requests). Set to `0` to skip waiting entirely for maximum speed.
