...
### Novita AI
Novita AI is an AI cloud platform that helps developers easily deploy AI models through a simple API, backed by affordable and reliable GPU cloud infrastructure. Try the [Novita AI LLM API Demo](https://novita.ai/models/llm/latest?utm_source=github_browseruse&utm_medium=github_readme&utm_campaign=link) today!
You can find all the models we support here: [Novita AI Featured Models](https://novita.ai/models?utm_source=github_browseruse&utm_medium=github_readme&utm_campaign=link) or request the [Models API](https://novita.ai/docs/api-reference/model-apis-llm-list-models?utm_source=github_browseruse&utm_medium=github_readme&utm_campaign=link) to get all available models.
The example is available [here](https://github.com/browser-use/browser-use/blob/main/examples/models/novita.py).
```python
from langchain_openai import ChatOpenAI
from browser_use import Agent
from pydantic import SecretStr
